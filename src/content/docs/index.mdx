...
hero:
  ...
  actions:
    - text: Physical AI Memory
      ...
      icon: right-arrow
    - text: Action-Outcome Evidence
      link: /research/action-outcome-evidence/
      icon: right-arrow
      variant: secondary
    - text: GitHub
...
<CardGrid>
  ...
  <Card title="Controlled pilot, not GA" icon="open-book">
...
[Action-Outcome Memory →](/use-cases/action-outcome-memory/) · [Research evidence →](/research/action-outcome-evidence/) · [Grounded overview →](/blog/physical-ai-action-outcome-memory/)
...
<CardGrid>
  ...
  <LinkCard title="Action-Outcome Memory" description="Physical AI action, recovery, suppression, and outcome memory" href="/use-cases/action-outcome-memory/" />
  <LinkCard title="Action-Outcome Evidence" description="Experiment 013-023 results, runtime maturity, and controlled-pilot boundaries" href="/research/action-outcome-evidence/" />
  <LinkCard title="Physical AI Research Overview" description="What ZeptoDB has actually validated, with research-only limits kept clear" href="/blog/physical-ai-action-outcome-memory/" />
