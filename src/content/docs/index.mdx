...
[See the complete experiment timeline →](/research/action-outcome-evidence/)
...
<CardGrid>
  ...
  <LinkCard title="Inspect the experiments" description="Result-first summaries, limitations, methods, and raw reproducible evidence" href="/research/action-outcome-evidence/" />
