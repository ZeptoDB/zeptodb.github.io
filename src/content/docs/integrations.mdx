...
<CardGrid>
  ...
  <Card title="ROS 2" icon="star">
    ...
    > ROS 2 connector support requires `-DZEPTO_USE_ROS2=ON`; IoT connectors require an Enterprise license.
  </Card>
</CardGrid>
...
Interested in an integration, or want to prioritize one? [Open an issue on GitHub](https://github.com/zeptodb/zeptodb/issues) or start a [GitHub Discussion](https://github.com/zeptodb/zeptodb/discussions).
