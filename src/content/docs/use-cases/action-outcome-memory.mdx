...
<CardGrid>
  <Card title="1.00 recovery Top-1" icon="approve-check-circle">
  ...
  <Card title="1.00 risky-repeat avoidance" icon="star">
...
[Read the evidence table →](/research/action-outcome-evidence/)
...
- **Edge-local memory** makes the immediate safety decision.
...
<CardGrid>
  <LinkCard title="Research Evidence" description="Experiment 013-023 results and maturity boundaries" href="/research/action-outcome-evidence/" />
  ...
  <LinkCard title="Research Overview" description="Grounded Physical AI memory scope, limits, and research-only claims" href="/blog/physical-ai-action-outcome-memory/" />
</CardGrid>
