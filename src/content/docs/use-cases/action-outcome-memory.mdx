...
[Follow the complete experiment timeline →](/research/action-outcome-evidence/)
...
<CardGrid>
  <LinkCard title="Action-Outcome Experiments" description="Result-first summaries, the experiment timeline, and maturity boundaries" href="/research/action-outcome-evidence/" />
