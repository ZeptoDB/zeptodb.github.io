...
prev: false
next: false
description: "ZeptoDB for grid agents — PMU streams, smart-meter telemetry, renewable assets, incident memory, and replayable operator decisions"
---
...
<CardGrid>
  ...
  <Card title="Incident memory" icon="open-book">
...
- Signed, offline-validated feature gates — no phone-home
