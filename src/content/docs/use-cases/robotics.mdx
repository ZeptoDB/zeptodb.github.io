...
The experiment track tests context-gated recall, native SQL replay, bounded edge-to-fleet transfer, and shadow-runtime failure cases. Results and limitations are maintained in the [Action-Outcome Experiments hub](/experiments/) so this page can stay focused on the robotics workflow.
