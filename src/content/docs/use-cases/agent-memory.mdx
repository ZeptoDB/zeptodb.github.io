...
For robot and embodied-agent memory, read [Physical AI Memory and Action-Outcome Memory](/blog/physical-ai-action-outcome-memory/), then see [Action-Outcome Memory](/use-cases/action-outcome-memory/) and the [research evidence](/research/action-outcome-evidence/) for the current controlled-pilot boundary.
