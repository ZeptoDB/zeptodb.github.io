...
See the [Quick Start Guide](/getting-started/quick_start/) and [vs kdb+](/compare/vs-kdb/) for a deeper comparison. Migration notes cover kdb+, ClickHouse, DuckDB, and TimescaleDB.
