...
The measured result and fixture boundaries live in [Experiment 013](/research/physical_ai_action_outcome_experiment_013/). This post is about what we changed because of it.
...
<CardGrid>
  <LinkCard title="Action-Outcome Experiments" description="Result-first summaries, the experiment timeline, limitations, and raw artifacts" href="/research/action-outcome-evidence/" />
