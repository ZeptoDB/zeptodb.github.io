...
description: "ZeptoDB started as a microsecond time-series database. Agent Memory adds scoped recall, context assembly, prompt cache, and decision write-back so agents can reason over live data."
