...
description: "Three enhancements to ZeptoDB's web query editor — interactive chart visualization with Recharts, multi-tab editing with localStorage persistence, and sequential multi-statement execution."
